          ...
          <div className="relative z-10 flex w-full max-w-md flex-shrink-0 flex-col items-center gap-4 xl:max-w-[380px] xl:ml-16 2xl:ml-20 hero-calculator-col">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
              <a
                ...
                className="inline-flex h-11 min-w-[155px] items-center justify-center rounded-[5px]"
                aria-label="Download on the App Store"
              >
                <img src="/images/Badges-app.svg" alt="" className="h-11 w-full object-contain object-center" />
              </a>
              <a
              ...
              >
                <img src="/images/Badges-google.svg" alt="" className="h-11 w-full object-contain object-center" />
              </a>
            </div>
          </div>
        </div>
